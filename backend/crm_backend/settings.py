...
SECRET_KEY = 'django-insecure-2w7wkn^9ef95gmo)*)%v87%g7q_h@(gmbzs3fh64+55q%)g$cw'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny', # Permite acceso a la API por defecto (cambia esto en producción)
    ],
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.SessionAuthentication',
        'rest_framework.authentication.TokenAuthentication', # Usaremos esto para React
    ],
}
